...
Controlled-access data is available to authorized users for specific research use only after approval by the Data Access Committee (DAC). The request process is described in this section.
...
3. You will also need to gather the following information to complete this process:

* **Research Use Statement** – A summary of research intent that describes 1) research objectives, 2) study design, and 3) analysis plan. **Note:** If your access request is approved, this will be a publicly viewable description.
...
* Brief description of how your proposed research is consistent with all applicable **Data Use Limitations (DULs)** for the requested data.
...
* [G. Renew access or submit closeout]({{ "/docs/renewing/" | relative_url }})
